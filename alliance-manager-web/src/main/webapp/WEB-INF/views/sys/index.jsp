...
<html>
  ...
  <body>
   <div class="right">
		...
		<script type="text/javascript">
			function add(){
				var html ="<div class='user-add'>\
				<div class='form-item'><label>所属地区：</label><div style='width:255px' class='select'><select class='myselect'><option value='1'>苏州事业部</option><option value='2'>苏州事业部2</option></select></div></div>\
				<div class='form-item'><label>联系人姓名：</label><input type='text'></div>\
				<div class='form-item'><label>登录名：</label><input type='text'></div>\
				<div class='form-item'><label>角色类型：</label><div style='width:255px' class='select'><select class='myselect'><option value='1'>苏州事业部</option><option value='2'>苏州事业部2</option></select></div></div>\
				<div class='form-item'><label>手机号码：</label><input type='text'></div>\
				<div class='form-item'><label>邮箱地址：</label><input type='text'></div>\
				<div class='form-item'><label>固定电话：</label><input type='text'></div>\
				</div>";
				layer.open({
					  type: 1,
					  title:"添加用户",
